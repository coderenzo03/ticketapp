...
public class CardEventoDTO {
    ...
    // Constructor vacío
    public CardEventoDTO() {
    }

    // Constructor con todos los campos
    public CardEventoDTO(String imagenUrl, String tipoEvento, String nombreEvento, String fecha, String precioMinimoEntrada) {
